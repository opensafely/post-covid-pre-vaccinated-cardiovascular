    ...
    action(
      ...
      moderately_sensitive = list(
        analyses_not_run = glue(
          "output/review/model/analyses_not_run_{outcome}_pre_vaccination.csv"
        ),
        compiled_hrs_csv = glue(
          "output/review/model/suppressed_compiled_HR_results_{outcome}_pre_vaccination.csv"
        ),
        compiled_hrs_csv_to_release = glue(
          "output/review/model/suppressed_compiled_HR_results_{outcome}_pre_vaccination_to_release.csv"
        ),
        compiled_event_counts_csv = glue(
          "output/review/model/suppressed_compiled_event_counts_{outcome}_pre_vaccination.csv"
        ),
        compiled_event_counts_csv_non_supressed = glue(
          "output/review/model/compiled_event_counts_{outcome}_pre_vaccination.csv"
        ),
        describe_data_surv = glue(
          "output/not-for-review/describe_{outcome}_*_time_periods.txt"
        )
      ),
...
actions_list <- splice(
  ...
  action(
    ...
    highly_sensitive = list(cohort = glue("output/input.feather"))
  ),
  ...
  action(
    ...
    highly_sensitive = list(cohort = glue("output/input_stage1.rds"))
  ),
  ...
  action(
    ...
    highly_sensitive = list(end_date_table = glue("output/follow_up_end_dates.rds"))
  ),
  ...
  action(
    ...
    moderately_sensitive = list(
      ...
      Descriptive_Table = glue(
        "output/review/descriptives/Table1_pre_vaccination_cvd.csv"
      )
    )
  ),
  ...
  action(
    ...
    needs = list("stage1_data_cleaning", "stage1_end_date_table"),
    moderately_sensitive = list(table_2 = "output/review/descriptives/table2_pre_vaccination_original_follow_up_any_position_events.csv")
  ),
  ...
  action(
    ...
    needs = list("stage1_data_cleaning", "stage1_end_date_table"),
    moderately_sensitive = list(table_2 = "output/review/descriptives/table2_pre_vaccination_extended_follow_up_any_position_events.csv")
  ),
  ...
  action(
    ...
    needs = list("stage1_data_cleaning", "stage1_end_date_table"),
    moderately_sensitive = list(table_2 = "output/review/descriptives/table2_pre_vaccination_original_follow_up_primary_position_events.csv")
  ),
  ...
  action(
    ...
    needs = list("stage1_data_cleaning", "stage1_end_date_table"),
    moderately_sensitive = list(table_2 = "output/review/descriptives/table2_pre_vaccination_extended_follow_up_primary_position_events.csv")
  ),
  ...
  action(
    ...
    needs =  list("stage1_data_cleaning", "stage1_end_date_table"),
    moderately_sensitive = list(histogram_data = "output/review/descriptives/histogram_data_pre_vaccination_original_follow_up.csv")
  ),
  ...
  action(
    ...
    needs =  list("stage1_data_cleaning", "stage1_end_date_table"),
    moderately_sensitive = list(histogram_data = "output/review/descriptives/histogram_data_pre_vaccination_extended_follow_up.csv")
  ),
  ...
  action(
    ...
    needs =  list("stage1_data_cleaning"),
    moderately_sensitive = list(distribution = "output/review/descriptives/days_COVID19_to_hospitalisation_pre_vaccination.csv")
  ),
  ...
  splice(# over outcomes
    unlist(
      lapply(outcomes_model,
             function(x)
               splice(unlist(
                 lapply(cohort_to_run, function(y)
                   apply_model_function(outcome = x, cohort = y)),
                 recursive = FALSE
               ))),
      recursive = FALSE
    )),
